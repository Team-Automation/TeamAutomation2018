...
public class CommonApi {
    ...
    public WebDriver getLocalDriver(String OS, String browser, String browserVersion) {
        if (browser.equalsIgnoreCase("firefox")) {
            ...
            if (OS.equalsIgnoreCase("mac")) {
                ...
                System.setProperty("webdriver.chrome.driver","/Users/hasibahmed/IdeaProjects/TeamAutomation2018/Generic/selenium-browser-driver/chromedriver");
                driver = new ChromeDriver();
    ...
    public void clickByClass (String locator){ driver.findElement(By.className(locator)).click(); }
